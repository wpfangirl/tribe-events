<?php
/**
 * Events Pro Photo Widget Template
 * This is the template for the output of the events photo grid widget.
 * All the items are turned on and off through the widget admin.
 * There is currently no default styling, which is highly needed.
 *
 * Override this template in your own theme by creating a file at [your-theme]/tribe-events/widgets/photo-widget.php
 *
...
if ( $posts ):
	foreach ( $posts as $post ) :
		setup_postdata( $post );
		do_action( 'tribe_events_widget_photo_inside_before_loop' ); ?>

		<!-- Event  -->
		<div class="<?php tribe_events_event_classes() ?>">
			<?php tribe_get_template_part( 'pro/widgets/modules/single-photo', null, $instance ) ?>
		</div><!-- .hentry .vevent -->

		<?php do_action( 'tribe_events_widget_photo_inside_after_loop' ) ?>
	<?php endforeach ?>
